      ...
      <div style={styles.grid}>
        {noticias.map((n) => (
          <div key={n.id} style={styles.card}>
            <div style={styles.img}><IconImagem /></div>
...
const styles = {
  ...
  img:        { background: '#F7F7F7', height: 140, display: 'flex', alignItems: 'center', justifyContent: 'center', borderBottom: '1px solid #E5E5E5' },
