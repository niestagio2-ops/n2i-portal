// ─── PÁGINA PUBLICAÇÕES ───────────────────────────────────
// Lista a produção científica dos membros do N2i.
// Funcionalidades:
//   - Filtro por tipo: Artigo / Conferência / Livro
//   - DOI com link directo
//   - Placeholder para integração futura com PlumX
// ─────────────────────────────────────────────────────────
...
function Publicacoes() {
  ...
  // Filtra publicações pelo tipo seleccionado
  ...
  return (
    <div>
      ...
      <div style={styles.filtros}>
        {tipos.map((t) => (
          <button key={t} onClick={() => setFiltro(t)} style={{ ...styles.btn, background: filtro === t ? '#E87722' : '#fff', color: filtro === t ? '#fff' : '#666', border: filtro === t ? '1.5px solid #E87722' : '1.5px solid #E5E5E5' }}>
            {t}
          </button>
        ))}
      </div>
        ...
        {lista.map((pub) => (
          <div key={pub.id} style={styles.card}>
            ...
            <div style={styles.cardRodape}>
              ...
              {/* Placeholder PlumX — substituir por widget real */}
